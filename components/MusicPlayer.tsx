...
export function MusicPlayer() {
  ...
  return (
    <>
      ...
      {/* Botón flotante de control de música - visible desde el inicio */}
      <motion.button
        initial={{ opacity: 0, scale: 0.8 }}
        animate={{ opacity: 1, scale: 1 }}
        transition={{ duration: 0.5, delay: 0.5 }}
        onClick={toggleMusic}
        className="fixed bottom-6 right-6 z-40 w-12 h-12 rounded-full bg-white-warm border-2 border-gold-soft flex items-center justify-center shadow-lg hover:bg-gold-soft hover:text-white-warm transition-all duration-300"
